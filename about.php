...
<body background="img/back.jpg">
    ...
    <main>
        ...
        <p>At Eternal Moments, we believe that every moment is a story waiting to be told. We are a passionate photography team dedicated to capturing the beauty, emotion, and essence of life's most precious moments. Whether it's an intimate travel experience or a grand celebration, we ensure that each photograph is a timeless memory.</p>

        <div class="about-section">
            <h3>Our Mission</h3>
            <p>Our mission is to provide you with the highest quality photography service that truly reflects your individual style and story. We aim to make every moment memorable by capturing it with precision, creativity, and artistry. Our photographers go beyond just taking pictures they create images that tell a unique, emotional, and meaningful story.</p>
        </div>
